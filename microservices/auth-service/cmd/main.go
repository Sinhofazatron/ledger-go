...
import (
	...
	"perfect-api/auth-service/internal/auth/handler"
	"perfect-api/auth-service/internal/auth/repository"
	"perfect-api/auth-service/internal/auth/service"

	"perfect-api/shared/config"
	"perfect-api/shared/database"
	"perfect-api/shared/logger"
	"perfect-api/shared/middleware"
